          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                subtitle:
                const Text('Directly call the ambulance hotline',
                    style: TextStyle(color: Colors.white)),
                onTap: () async {
                  ...
                  try {
                    ...
                    if (snapshot.exists) {
                      ...
                      for (final user in snapshot.children) {
                        if (user.child("UserType").value == "Ambulance") {
                          //zanecoUserUID = user.key;
                          ambulancePhone = user.child("Phone").value.toString();
                  ...
                  if (ambulancePhone == null || ambulancePhone.isEmpty) {
                  ...
                  if (await Permission.phone.request().isGranted) {
                    ...
                    var uri = Uri.parse('tel:$ambulancePhone');
                    await launchUrl(uri);
