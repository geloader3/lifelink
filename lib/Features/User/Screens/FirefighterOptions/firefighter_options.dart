          ...
          children: [
            ...
            Card(
              child: ListTile(
                  ...
                  subtitle:
                  const Text('Directly call the fire station hotline',style: TextStyle(
                      color: Colors.white
                  ...
                  onTap: () async {
                    ...
                    try {
                      ...
                      if (snapshot.exists) {
                        ...
                        for (final user in snapshot.children) {
                          if (user.child("UserType").value == "FireFighter") {
                            //zanecoUserUID = user.key;
                            firePhone = user.child("Phone").value.toString();
                    ...
                    if (firePhone == null || firePhone.isEmpty) {
                    ...
                    if (await Permission.phone.request().isGranted) {
                      ...
                      var uri = Uri.parse('tel:$firePhone');
                      await launchUrl(uri);
